...
export function ConsumptionPredictionGraph({url_in, future_steps}) {
  ...
  return (
    <div className="size-full flex flex-col">
      <div className="mt-5 pr-5 items-start">

        <div className="flex flex-col gap-2 items-start pl-5">
          <div className="flex flex-row gap-2 items-center" onMouseEnter={()=>setColorFuture("#d0e3b6")} onMouseLeave={()=>setColorFuture('#65A30D')}>
            <div className="size-5 bg-lime-300 shadow-md rounded-sm" />
            <h1 className="font-[Inter] text-gray-800 text-xl">{t("Past real consumption")}</h1>
          </div>

          <div className="flex flex-row gap-2 items-center" onMouseEnter={()=>setColorPast("#E3F7C2")} onMouseLeave={()=>setColorPast('#a3e635')}>
            <div className="size-5 bg-lime-600 shadow-md rounded-sm" />
            <h1 className="font-[Inter] text-gray-800 text-xl">{t("Future predicted consumption")}</h1>
          </div>
        </div>
      </div>
