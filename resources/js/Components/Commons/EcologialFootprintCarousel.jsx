...
const kWhComparisons = (kWh,t) => {
  ...
  return [
    { 
      icon: <FaCar className="text-5xl text-slate-600" />, 
      text: t("Driving for :value km", {
        value: (kgCO2e / 0.192).toFixed(1)})
    },
    { 
      icon: <FaCoffee className="text-5xl text-amber-800" />,
      text: t("Making :value cups of coffee", {
        value: (kgCO2e / 0.29).toFixed(1)}) 
    },
    { 
      icon: <FaPizzaSlice className="text-5xl text-yellow-400" />,
    ...
    { 
      icon: <FaMobileAlt className="text-5xl text-gray-600" />,
...
export const EcologicalFootprintCarousel = ({ kWh }) => {
  ...
  return (
    <div className="w-full h-40 2xl:hidden">
...
export const EcologicalFootprintGrid = ({ kWh }) => {
  ...
  return (
    <div className="w-full mx-auto xl:hidden 2xl:block">
