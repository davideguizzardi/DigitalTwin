...
\begin{document}
 ...
 \input{0 - Intestazioni extra/title} %Frontespizio 
    ...
    \tableofcontents
    \input{0 - Intestazioni extra/Introduzione} % Introduzione
    \mainmatter
    \input{1 - Capitoli/Capitolo 1}
    \input{1 - Capitoli/Capitolo 2 - Stato dell'arte}
    \input{1 - Capitoli/Capitolo 3 - Architettura}
    \backmatter
    \input{0 - Intestazioni extra/Conclusioni}
    \printbibliography
\end{document}
